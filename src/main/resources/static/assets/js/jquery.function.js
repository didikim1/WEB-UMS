...
//		this.layout({id:"fn_js_confirm",title:conf.title ? conf.title:'메세지',content:conf.content,width:conf.width,action:conf.action,closeAction:conf.closeAction, buttons:{}});
		this.layout({id:"fn_js_confirm",title:conf.title ? conf.title:'메세지',content:conf.content,width:conf.width,action:conf.action,closeAction:conf.closeAction, buttons:conf.buttons});
	},alert:function(conf){
