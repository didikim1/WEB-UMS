...
public class LmsSendRunnable implements Runnable {
	
	public static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(LmsSendRunnable.class);
	...
	public LmsSendRunnable(String pROJECT_ID, String req_id, String request_time, String callback, String subject,
			String message, String return_type, String dstPhone) {
		super();
		this.req_id 		= req_id;
...
//		String dstUrl = "https://api-gemtek.ring2pay.com:48040/api/async/sender/sms";
		String dstUrl = "https://api-gemtek.ring2pay.com:48040/api/sender/sync/lms";
...
//		JSONArray 	targetAry 	= null;
		...
		sendMap.put("subject",      	this.subject);
