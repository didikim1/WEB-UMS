...
<!-- 												</li> -->
									...
									<div class="ttsMsgBox">
										<div class="ttsWriteBox">
											<textarea class="text_title" rows="1" cols="155" name="ttsMent1" maxlength="100" style="color:#999;">OO에서보내는 안내문자입니다. </textarea>
										...
										<div class="surveyOuter">
											<div class="surveyInner">
												<div class="ttsWriteBox">
													<textarea class="text_contente" rows="5" cols="155" name="ttsMent2" maxlength="2000" style="color:#999;">[전달 내용 입력]</textarea>
												</div>
											</div>
										</div>
									</div>
