...
<style>
	...
	input[type=checkbox] {width:15px !important;height:15px !important;margin-left:9px;}
</style>
...
<!-- 					<a href="#"><button class="btn_service" id="btnService">서비스 소개</button></a> -->
		...
		<!-- search -->
		<form action="/survey/SurveyResultList" name="searchForm" method="POST">
