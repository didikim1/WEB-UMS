...
<style>
	...
	.btnResend, .btnSelectedResend, .btnDownload { width:75px;height:25px;padding:3px 5px !important;float:none !important;margin-left:0px !important;font-size:13px !important; }
...
<!-- 					<a href="#"><button class="btn_service" id="btnService">서비스 소개</button></a> -->
		...
		<!-- search -->
		<form action="/result/ResultDetailList" name="searchForm" method="POST">
			...
			<table>
				...
				<thead>
					<tr>
						...
						<th>전화번호</th>
						<th><label class="pointer" onclick="javacript:fn_Sorting('RESULT_TYPE');">전송결과</label></th>
						<th><label class="pointer" onclick="javacript:fn_Sorting('RESULT');">처리결과코드</label></th>
						<th><label class="pointer" onclick="javacript:fn_Sorting('USER_INPUT');">회신결과</label></th>
						<th><label class="pointer" onclick="javacript:fn_Sorting('CALLDURATION');">통화시간</label></th>
						<th>수동처리</th>
					</tr>
				</thead>
				<tbody>
